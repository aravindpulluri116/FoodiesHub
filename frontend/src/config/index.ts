...
export const config: Config = {
  apiUrl: (import.meta.env.VITE_API_URL || 'https://foodieshubbackend.vercel.app/api').replace(/\/+$/, ''),
  apiBaseUrl: (import.meta.env.VITE_API_BASE_URL || 'https://foodieshubbackend.vercel.app').replace(/\/+$/, ''),
